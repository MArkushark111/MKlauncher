...
func main() {
	...
	router.HandleFunc("/api/games/url", api.RequireAuth(api.HandleAddGameURL)).Methods("POST")
	router.HandleFunc("/api/games/dev", api.RequireAuth(api.HandleCreateDeveloperGame)).Methods("POST")
	...
	router.HandleFunc("/api/games/{id:[0-9]+}/reviews", api.HandleGetReviews).Methods("GET")
	router.HandleFunc("/api/games/{id:[0-9]+}/reviews", api.HandleAddReview).Methods("POST")
	...
	router.HandleFunc("/api/games/{id:[0-9]+}/screenshots", api.RequireAuth(api.HandleAddScreenshot)).Methods("POST")
	router.HandleFunc("/api/screenshots/{id:[0-9]+}", api.RequireAuth(api.HandleDeleteScreenshot)).Methods("DELETE")
	router.HandleFunc("/api/news", api.HandleGetNews).Methods("GET")
	router.HandleFunc("/api/news", api.RequireAuth(api.HandleAddNews)).Methods("POST")
	router.HandleFunc("/api/news/{id:[0-9]+}", api.RequireAuth(api.HandleDeleteNews)).Methods("DELETE")
	router.HandleFunc("/api/games/featured", api.HandleGetFeatured).Methods("GET")
	router.HandleFunc("/api/games/{id:[0-9]+}/featured", api.RequireAuth(api.HandleSetFeatured)).Methods("POST")
	router.HandleFunc("/api/playtime", api.RequireAuth(api.HandleTrackPlaytime)).Methods("POST")
	router.HandleFunc("/api/playtime", api.RequireAuth(api.HandleGetPlaytime)).Methods("GET")
	router.HandleFunc("/api/recently-played", api.RequireAuth(api.HandleUpdateRecentlyPlayed)).Methods("POST")
	router.HandleFunc("/api/recently-played", api.RequireAuth(api.HandleGetRecentlyPlayed)).Methods("GET")
	router.HandleFunc("/api/wishlist", api.RequireAuth(api.HandleGetWishlist)).Methods("GET")
	router.HandleFunc("/api/wishlist/{game_id:[0-9]+}", api.RequireAuth(api.HandleToggleWishlist)).Methods("POST")
	router.HandleFunc("/api/games/{id:[0-9]+}/achievements", api.HandleGetAchievements).Methods("GET")
	router.HandleFunc("/api/games/{id:[0-9]+}/achievements", api.RequireAuth(api.HandleAddAchievement)).Methods("POST")
	router.HandleFunc("/api/achievements/{id:[0-9]+}/unlock", api.RequireAuth(api.HandleUnlockAchievement)).Methods("POST")
	...
	router.HandleFunc("/api/games/{id:[0-9]+}/mods", api.HandleGetMods).Methods("GET")
	router.HandleFunc("/api/games/{id:[0-9]+}/mods", api.RequireAuth(api.HandleAddMod)).Methods("POST")
	router.HandleFunc("/api/mods/{id:[0-9]+}", api.RequireAuth(api.HandleDeleteMod)).Methods("DELETE")
	router.HandleFunc("/api/games/{id:[0-9]+}/servers", api.HandleGetServers).Methods("GET")
	router.HandleFunc("/api/games/{id:[0-9]+}/servers", api.RequireAuth(api.HandleAddServer)).Methods("POST")
	router.HandleFunc("/api/servers/{id:[0-9]+}", api.RequireAuth(api.HandleUpdateServer)).Methods("PUT")
	router.HandleFunc("/api/servers/{id:[0-9]+}", api.RequireAuth(api.HandleDeleteServer)).Methods("DELETE")
